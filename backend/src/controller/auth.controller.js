...
export async function signup(req, res) {
  ...
  try {
    ...
    try {
      ...
      console.error("Error in upserting Stream user during signup:", error);
    }
...
export async function onboard(req, res) {
  try {
    ...
    //also update the name in STREAM
   ...
   try{
    ...
    console.error("Error in upserting Stream user during onboarding:", error);
   }
